  ...
  return (
    <section id="about" className={styles.container}>
      ...
      <p className={styles.description}>
        I am an undergraduate computer science student at Dalhousie University, currently in my third year. My curiousity in tech began in high school, when I taught myself basic web development. I was drawn to the control, flexibility, and customizability I had with the ability to code and use technical tools effectively.
        Fast forward to today, I am most excited about full stack software development and cybersecurity, and I also possess skills and knowledge in cloud computing, artificial intelligence, data analytics, DevOps, and web design. I've had the privilege of creating a website to further ocean science education, sharing my love for tech with youth across Nova Scotia, and making applications for an airline.
        <br /><br />
